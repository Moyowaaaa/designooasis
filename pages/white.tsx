      ...
      <PageContentLayout>
        ...
        >
          <div className="w-max  flex flex-col items-center justify-center w-[31.25rem] gap-[2rem]">
            <h1 className="font-[400] font-[grotesk-light] text-[#151515] text-[9.375rem] leading-[100%] text-center">
              Design <br />
            ...
            <button className="flex items-center justify-center gap-[10px] p-[0.8rem] border-2 border-[#151515] w-[15rem] text-[1.875rem] text-#151515">
              <p>START A PROJECT</p>
              <svg
            ...
            <p className="text-[0.875rem] font-[satoshi] text-[#151515]">
          ...
          <div className="absolute bottom-[30px] w-full  text-center">
            <p className="text-[0.875rem] text-#151515 font-[satoshi] font-[700]">
